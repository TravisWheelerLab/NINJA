        ...
        if (!x.compare("--in") || !x.compare("-i")) {
            ...
            if (i < argc - 1) {
                if (!y.compare("default")) {
                    ...
                    fprintf(stderr,
                            "Invalid method: available methods are  'default', "
                            "'inmem', and 'extmem'.");
                    Exception::critical();
                }
                i++;
            ...
            /*		}else if (!x.compare("--verbose")){
                                    if (i < argc-1){
                                            ...
                                            fprintf(stderr,"No verbose integer
               specified.\n"); Exception::critical();
                                    }*/
            ...
            /*		}else if (!x.compare("--clust_size") ||
               !x.compare("-s")){ if (i < argc-1){ int s = *argv[i+1] - '0';
               //revisit
                                            //TreeBuilder.clustCnt = s; TODO:
                                            i++;
                                    }else{
                                            fprintf(stderr,"No clust_size
               integer specified.\n"); Exception::critical();
                                    }
               ...
               NULL, 0);
                                            ...
                                            fprintf(stderr,"No
               rebuild_step_ratio integer specified.\n"); Exception::critical();
                                    }*/
