...
class ArrayHeapExtMem {
  ...
  public:
    ...
    int maxLevels;
    float c; // was 1/7 in the paper, but I'm storing other values with the key,
             // so I've changed the ratio
    ...
    BinaryHeap_FourInts *H2; // same thing as the above, with 4 ints instead of
                             // 2
  ...
  private:
    ...
    void deleteLevelAndSlots(BinaryHeap_FourInts *H, int level, int *slots,
                             int numSlots);
