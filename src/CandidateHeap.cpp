...
CandidateHeap::CandidateHeap(std::string dir, int *activeIJs, int kPrime,
                             TreeBuilderExtMem *tb, long sizeExp)
...
CandidateHeap::CandidateHeap(std::string dir, int *activeIJs, int kPrime,
    ...
    : ArrayHeapExtMem(dir, activeIJs) {
    initialize(kPrime, tb);
}
CandidateHeap::~CandidateHeap() { clear(); }
